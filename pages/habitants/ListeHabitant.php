        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Liste des habitants</li>
                </ol>
              </nav>
            </div>
            ...
            <?php 
                ...
                $req = mysqli_query($conn , "SELECT * FROM habitant");
                if(mysqli_num_rows($req) == 0){
                    //s'il n'existe pas d'employé dans la base de donné , alors on affiche ce message :
                    echo "Il n'y a pas encore habitant ajouter !" ;
                    ...
                    //     ?>
                        ...
                        <td><?=$row['NOM_HAB']?></td>
                        <td><?=$row['PREN_HAB']?></td>
                        <td><?=$row['DATE_NAISS_HAB']?></td>
                        <td><?=$row['SEXE_HAB']?></td>
                        <td><?=$row['PROF_HAB']?></td>
                        <td><?=$row['SAVOIR_FAIRE_HAB']?></td>
                        <td><?=$row['CONT_HAB']?></td>
                           
                            <!--Nous alons mettre l'id de chaque employé dans ce lien -->
                            <td><a href=""><i class="fa-solid fa-pen"></i></td>
