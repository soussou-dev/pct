        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <tr  class="bg-gradient-primary text-white " id="items">
                ...
                <th>Spécialité du service</th>
                
            </tr>
            <?php 
                //inclure la page de connexion
                include_once "conection.php";
                //requête pour afficher la liste des services
                $req = mysqli_query($conn , "SELECT * FROM service");
                if(mysqli_num_rows($req) == 0){
                    //s'il n'existe pas de service dans la base de donné , alors on affiche ce message :
                    echo "Il n'y a pas encore de services ajouter !" ;
                    ...
                    //     ?>
                        ...
                        <td><?=$row['SPE_SERV']?></td>
                            ...
                            <td><a href=""><img src="images/pen.png"></a></td>
