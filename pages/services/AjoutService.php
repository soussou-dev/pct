      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <form action="traitementservice.php" method="POST" class="forms-sample">
              
                      <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Nom du service</label>
                        <div class="col-sm-9">
                          <input type="text" name="nomprojet" class="form-control" id="exampleInputUsername2" placeholder="Entrez le nom du service">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Libellé du service</label>
                        <div class="col-sm-9">
                          <input type="text" name="libelleprojet" class="form-control" id="exampleInputUsername2" placeholder="Entrez une description du service">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Spécialité du service</label>
                        <div class="col-sm-9">
                          <input type="text"  name="initiateurprojet" class="form-control" id="exampleInputUsername2" placeholder="Entrez la spécialité du projet">
                        </div>
                      </div>
                      ...
                      <button type="submit" name="save_service" class="btn btn-gradient-primary me-2">Enregistrer</button>
