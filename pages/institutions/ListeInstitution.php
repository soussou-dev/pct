        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Institutions</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Institutions</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Liste des institutions</li>
                </ol>
              </nav>
            </div>
            ...
            <thead>
            <tr  class="bg-gradient-primary text-white " id="items">

                <th>id</th>
                <th>Nom de l'institution</th>
                <th>Responsable de l'institution</th>
                <th>Description de l'institution</th>
                <th>Contact  de l'institution</th>
            ...
            <?php 
                ...
                //requête pour afficher la liste des projets
                $req = mysqli_query($conn , "SELECT * FROM institution");
                if(mysqli_num_rows($req) == 0){
                    //s'il n'existe pas de projets dans la base de données , alors on affiche ce message :
                    echo "Il n'y a pas encore d'institution ajouter !" ;
                    
                }else {
                    //si non , affichons la liste de toutes les institutions
                    ...
                    <tbody>
                        ...
                        <td><?=$row['CONT_INST']?></td>
                            ...
                            <!--Nous allons mettre l'id de chaque institution dans ce lien -->
                           
                            <td><a href="modifierinstitution.php?id=<?=$row['ID_INST']?>"><i class="fa-solid fa-pen"></i></td>
                            <td><a href="supprimerinstitution.php?id=<?=$row['ID_INST']?>"><i class="fa-solid fa-trash"></i></td>
                        </tr>
                        </tbody>
                        <?php
                   }
