      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <h3 class="page-title">Intitutions</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Institutions</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Ajouter une institution</li>
                </ol>
              </nav>
            </div>
            <form action="traitementinstitution.php" method="post" enctype="multipart/form-data" class="forms-sample">
           
                <div class="form-group row">
                        <label for="commune" class="col-sm-3 col-form-label">Commune</label>
                        <div class="col-sm-9">
                          <input type="text" name="commune" class="form-control" id="commune" placeholder="Entrer votre commune ">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="rue" class="col-sm-3 col-form-label">Rue</label>
                        <div class="col-sm-9">
                          <input type="text" name="rue" class="form-control" id="rue" placeholder="Entrer votre rue">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="quartier" class="col-sm-3 col-form-label">Quartier</label>
                        <div class="col-sm-9">
                          <input type="text" name="quartier" class="form-control" id="quartier" placeholder="Entrer votre quartier">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="nominstitution" class="col-sm-3 col-form-label">Nom de l'institution</label>
                        <div class="col-sm-9">
                          <input type="text" name="nominstitution" class="form-control" id="nominstitution" placeholder="Entrez le nom de l'institution ">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="responsableinstitution" class="col-sm-3 col-form-label">Nom du responsable de l'institution</label>
                        <div class="col-sm-9">
                          <input type="text" name="responsableinstitution" class="form-control" id="responsableinstitution" placeholder="Entrez le nom du responsable de l'institution">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="descriptioninstitution" class="col-sm-3 col-form-label">Description de l'institution</label>
                        <div class="col-sm-9">
                          <input type="text" name="descriptioninstitution" class="form-control" id="descriptioninstitution" placeholder="Entrez une description de l'institution">
                        </div>
                      </div>
       
                      
                      <div class="form-group row">
                        <label for="contactinstitution"  class="col-sm-3 col-form-label">Contact</label>
                        <div class="col-sm-9">
                          <input type="text" name="contactinstitution" class="form-control" id="contactinstitution" placeholder="Entrer le contact de l'institution">
                        </div>
                      </div>

                      <button type="submit" name="save_institution" class="btn btn-gradient-primary me-2">Enregistrer</button>
