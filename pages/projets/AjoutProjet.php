      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <form action="traitementprojet.php" method="post" enctype="multipart/form-data" class="forms-sample">
           
            <div class="form-group row">
                        <label for="nomprojet" class="col-sm-3 col-form-label">Nom du projet</label>
                        <div class="col-sm-9">
                          <input type="text" name="nomprojet" class="form-control" id="nomprojet" placeholder="Entrez le nom du projet">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="libelleprojet" class="col-sm-3 col-form-label">Libellé du projet</label>
                        <div class="col-sm-9">
                          <input type="text" name="libelleprojet" class="form-control" id="libelleprojet" placeholder="Entrez une description du projet">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="initiateurprojet" class="col-sm-3 col-form-label">Initiateur du projet</label>
                        <div class="col-sm-9">
                          <input type="text"  name="initiateurprojet" class="form-control" id="initiateurprojet" placeholder="Entrez l'initiateur du projet">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="cibleprojet" class="col-sm-3 col-form-label">Cible du projet</label>
                        <div class="col-sm-9">
                          <input type="text"  name="cibleprojet" class="form-control" id="cibleprojet" placeholder="Entrez la cible du projet">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="debutprojet" class="col-sm-3 col-form-label">Date de début du projet</label>
                        <div class="col-sm-9">
                          <input type="date" name="debutprojet" class="form-control" id="debutprojet" placeholder="Entrez la date de début du projet">
                        </div>
                      </div>

                      <div class="form-group row">
                        <label for="finprojet" class="col-sm-3 col-form-label">Date de fin du projet</label>
                        <div class="col-sm-9">
                          <input type="date" name="finprojet" class="form-control" id="finprojet" placeholder="Entrez la date de début du projet">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="contact" class="col-sm-3 col-form-label">Contact</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control"  name="contact" id="contact" placeholder="Entrez le contact du l'initiateur du projet">
                        </div>
                      </div>
