          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Centres</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Ajouter un centres de santé</li>
                </ol>
              </nav>
            </div>
           
            <form class="forms-sample" action="traitementcentre.php" method="post"  enctype="multipart/form-data">
            <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <label  for="nomcentre" class="col-sm-3 col-form-label">Nom du centre de santé </label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control"  id="nomcentre" name="nomcentre" placeholder="Ajouter le nom du centre de santé">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="assurance" class="col-sm-3 col-form-label">Assurance prise en charge</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="assurance" name="assurance" placeholder="Ajouter une assurance prise en charge par le centre de santé">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="typecentre" class="col-sm-3 col-form-label">Type de centre</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="typecentre" name="typecentre" placeholder="Quel est le type de votre centre de santé">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="contactcentre" class="col-sm-3 col-form-label">Contact du centre</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="contactcentre" name="contactcentre" placeholder="Quel est le contact du centre de sante">
                        </div>
                      </div>
                      ...
                      <button type="submit" name="save_centre" class="btn btn-gradient-primary me-2">Enregistrer</button>
