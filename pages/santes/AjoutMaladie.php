        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Maladies</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="#">Maladies</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Ajouter une Maladie</li>
                </ol>
              </nav>
            </div>
           
                    <form class="forms-sample" action="traitementmaladie.php" method="post"  enctype="multipart/form-data">
                      <div class="form-group row">
                        <label  for="nommaladie" class="col-sm-3 col-form-label">Nom de la maladie </label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control"  id="nommaladie" name="nommaladie" placeholder="Ajouter le nom de la maladie">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="descriptionmaladie" class="col-sm-3 col-form-label">Decrivez la maladie</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="descriptionmaladie" name="descriptionmaladie" placeholder="Ajouter les caractéristiques de la maladie">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="victimemaladie" class="col-sm-3 col-form-label">le nombre de victime </label>
                        <div class="col-sm-9">
                          <input type="number" class="form-control" id="victimemaladie" name="victimemaladie" placeholder="Ajouter une description à cette actualité">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="personnevulnérable" class="col-sm-3 col-form-label">Personne vulnérable </label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="personnevulnérable" name="personnevulnérable" placeholder="Ajouter les personnes vulnérable à la maladie">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="decouvertemaladie" class="col-sm-3 col-form-label">Date de découverte</label>
                        <div class="col-sm-9">
                          <input type="date" class="form-control" id="decouvertemaladie" name="decouvertemaladie" placeholder="Ajouter la date de découverte de la maladie">
                        </div>
                      </div>
                      ...
                      <button type="submit" name="save_maladie" class="btn btn-gradient-primary me-2">Enregistrer</button>
