            ...
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Ajouter une Pharmacies</li>
                </ol>
              </nav>
            </div>
           
                    <form class="forms-sample" action="traitementpharmacie.php" method="post"  enctype="multipart/form-data">
                      <div class="form-group row">
                        <label  for="communepharmacie" class="col-sm-3 col-form-label">Commune de la pharmacie</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control"  id="communepharmacie" name="communepharmacie" placeholder="Ajouter la situation géographique de la pharmacie">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label  for="quartierpharmacie" class="col-sm-3 col-form-label">Quartier de la pharmacie</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control"  id="quartierpharmacie" name="quartierpharmacie" placeholder="Ajouter la commune de la pharmacie">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label  for="ruepharmacie" class="col-sm-3 col-form-label">Rue de la pharmacie</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control"  id="ruepharmacie" name="ruepharmacie" placeholder="Ajouter la commune de la pharmacie">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label  for="nompharmacie" class="col-sm-3 col-form-label">Nom de la pharmacie</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control"  id="nompharmacie" name="nompharmacie" placeholder="Ajouter le nom de la pharmacie">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="assurancepharmacie" class="col-sm-3 col-form-label">Assurance prise en charge</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="assurancepharmacie" name="assurancepharmacie" placeholder="Ajouter une assurance prise en charge par la pharmacie">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="contactpharmacie" class="col-sm-3 col-form-label">Contact de la pharmacie</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="contactpharmacie" name="contactpharmacie" placeholder="Ajouter le contact de la pharmacie">
                        </div>
                      </div>
                      <!-- <div class="form-group row">
                        <label for="descriptionactualite" class="col-sm-3 col-form-label">type de centre</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="descriptionactualite" name="descriptionactualite" placeholder="Quel est le type de votre centre de santé">
                        </div>
                      </div> -->
                      <!-- <div class="form-group row">
                        <label for="imageactualite" class="col-sm-3 col-form-label">Image de l'actualité</label>
                        <div class="col-sm-9">
                          <input type="file" class="form-control" id="imageactualite" name="imageactualite">
                        </div>
                      </div> -->
                      ...
                      <button type="submit" name="save_pharmacie" class="btn btn-gradient-primary me-2">Enregistrer</button>
