              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Ajouter une actualité</li>
                    ...
                    <form class="forms-sample" action="traitementactualite.php" method="post"  enctype="multipart/form-data">
                      <div class="form-group row">
                        <label  for="titreactualite" class="col-sm-3 col-form-label">Titre de l'actualité</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control"  id="titreactualite" name="titreactualite" placeholder="Ajouter un titre à cette actualité">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="typeactualite" class="col-sm-3 col-form-label">Type de l'actualité</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="typeactualite" name="typeactualite" placeholder="Ajouter un type à cette actualité">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="descriptionactualite" class="col-sm-3 col-form-label">Description de l'actualité</label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="descriptionactualite" name="descriptionactualite" placeholder="Ajouter une description à cette actualité">
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <button type="submit" name="save_actualite" class="btn btn-gradient-primary me-2">Enregistrer</button>
